...
source <(curl -fsSL https://raw.githubusercontent.com/suprmorten/ProxmoxVED/main/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/suprmorten/ProxmoxVED/main/misc/tools.func)

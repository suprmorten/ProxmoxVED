...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/suprmorten/ProxmoxVED → Fork (top right)
...
git remote add upstream https://github.com/suprmorten/ProxmoxVED.git
...
- **GitHub**: https://github.com/suprmorten/ProxmoxVED
- **Issues**: https://github.com/suprmorten/ProxmoxVED/issues
- **Discussions**: https://github.com/suprmorten/ProxmoxVED/discussions

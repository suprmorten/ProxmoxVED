...
# upstream   https://github.com/suprmorten/ProxmoxVED.git (fetch)
# upstream   https://github.com/suprmorten/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/suprmorten/ProxmoxVED"
echo ""
